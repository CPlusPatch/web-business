				...
				<div class="flex lg:m-0 gap-y-6 duration-200">
					<ClientOnly>
						<Carousel
							...
							:wrap-around="true">
							<Slide
								v-for="testi of testimonials"
								:key="testi.name"
								class="px-4 sm:px-6 lg:px-0 flex justify-center">
								<blockquote class="max-w-2xl">
									<div>
										...
										<p
											class="mt-6 text-2xl font-medium text-white font-inter duration-200">
											{{ testi.text }}
										</p>
									</div>
									<footer class="mt-6">
										<p
											class="text-base font-medium text-white font-poppins">
											{{ testi.name }}
										</p>
										<p
											class="text-base font-medium text-indigo-100 font-poppins">
											{{ testi.profession }}
										</p>
									</footer>
								</blockquote>
