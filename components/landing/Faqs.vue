...
const faq = [
	...
	},
	{
		...
		"answer": "Definitely Vue.js + TailwindCSS (with TypeScript), it lets me create so many different things with an easy but powerful syntax!"
	},
	{
...
<template>
	<PrimaryContainer>
		<div class="mx-auto max-w-3xl flex flex-col gap-y-10">
			<h2 class="text-3xl font-extrabold text-center text-gray-900 dark:text-gray-200 sm:text-4xl font-poppins">
				Frequently asked questions
			</h2>
			<dl class="gap-y-3 flex flex-col">
				<Disclosure :key="group.question" v-for="group of faq" v-slot="{ open }">
							...
							<DisclosureButton
								...
								<span class="flex items-center ml-6 h-7">
									<IconChevronDown :class="[open
										? '-rotate-180'
										: 'rotate-0',
										'w-6 h-6 duration-300 ease-in-out transform']" aria-hidden="true" />
								</span>
							</DisclosureButton>
						</dt>
